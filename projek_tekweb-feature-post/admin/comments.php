...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-md px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        ...
        <div class="flex items-center gap-4">
            <a href="../home.php" target="_blank" class="text-blue-600 hover:text-blue-700 font-medium">
                <i class="fas fa-external-link-alt"></i> View Site
            </a>
            <a href="Dashboard.php" class="text-gray-600 hover:text-blue-600">
                <i class="fas fa-tachometer-alt"></i> Dashboard
            </a>
            <a href="posts.php" class="text-gray-600 hover:text-blue-600">
                <i class="fas fa-newspaper"></i> Posts
            </a>
            <a href="../logout.php" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded text-sm">
