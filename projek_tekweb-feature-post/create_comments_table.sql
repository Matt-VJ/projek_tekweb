...
(1, 'John Doe', 'john@example.com', 'Great article! Very informative.', 'approved'),
(1, 'Jane Smith', 'jane@example.com', 'Thanks for sharing this!', 'approved'),
(2, 'Bob Wilson', 'bob@example.com', 'This tutorial helped me a lot.', 'approved');
